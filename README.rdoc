...
Updated app to have validations: comments are between 50 and 500 characters, video names are unique, ages must be between 18 and 100.
This wasn't too bad. I had to lookup how to validate a value between a range and how to make the error message. I had some trouble
with having the error message show up. For some reason it wouldn't work with :validates, so I had to do :validates_inclusion_of 
and this worked.
